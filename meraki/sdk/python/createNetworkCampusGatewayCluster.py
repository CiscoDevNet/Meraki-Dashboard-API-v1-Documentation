...
port_channels = [{'name': 'Port-channel1', 'vlan': 25, 'allowedVlans': '10-20'}]

response = dashboard.campusGateway.createNetworkCampusGatewayCluster(
    network_id, name, uplinks, tunnels, nameservers, port_channels, 
