...
response = dashboard.networks.updateNetworkAlertsSettings(
    ...
    alerts=[{'type': 'gatewayDown', 'enabled': True, 'alertDestinations': {'emails': ['miles@meraki.com'], 'allAdmins': False, 'snmp': False, 'httpServerIds': ['aHR0cHM6Ly93d3cuZXhhbXBsZS5jb20vd2ViaG9va3M=']}, 'filters': {'conditions': [{'type': 'temperature', 'unit': 'celsius', 'duration': 0, 'direction': '+', 'threshold': 72.5}], 'failureType': '802.1X auth fail', 'lookbackWindow': 360, 'minDuration': 60, 'name': 'Filter', 'period': 1800, 'priority': '', 'regex': '[a-z]', 'selector': '{"smartSensitivity":"medium","smartEnabled":false,"eventReminderPeriodSecs":10800}', 'serials': ['Q234-ABCD-0001', 'Q234-ABCD-0002', 'Q234-ABCD-0003'], 'ssidNum': 1, 'tag': 'tag1', 'threshold': 30, 'timeout': 60}}], 
